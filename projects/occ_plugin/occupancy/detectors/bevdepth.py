...
class BEVDet(CenterPoint):
    def __init__(self, img_view_transformer=None,
                 img_bev_encoder_backbone=None,
                  gauss_lifter=None, gauss_encoder=None, head=None,
        ...
        if gauss_lifter is not None:
            self.gauss_lifter = MODELS.build(gauss_lifter)
        else:
            self.gauss_lifter = None
            
        if gauss_encoder is not None:
            self.gauss_encoder = MODELS.build(gauss_encoder)
        else:
            self.gauss_encoder = None
